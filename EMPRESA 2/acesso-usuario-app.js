...
const EMPRESA_PREFIX = 'empresa2_';
...
function carregarUsuariosDisponiveis() {
    ...
    if (tipo === 'elenco') {
        usuarios = JSON.parse(localStorage.getItem('elenco_cadastrados') || '[]');
    } else if (tipo === 'motorista') {
        usuarios = JSON.parse(localStorage.getItem('motoristas_cadastrados') || '[]');
    }
